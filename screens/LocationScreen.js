    ...
    <View style={styles.item}>
      ...
      <Pressable
        ...
        onPress={() => {
          ...
          showAlert(`${chain} ${address}, ${city} ${state}, ${zip} Selected!`);
        }}
      >
  ...
  render() {
    return (
      <SafeAreaView style={globalStyle.wholeScreen}>
        <View>
          <Text style={globalStyle.headerText} testID="Test_SearchTextHeader">
            Choose a Store
          </Text>
        ...
        <View style={styles.fixedButton}>
          ...
          >
            <Text style={globalStyle.wideButtonText}>Continue</Text>
          </Pressable>
        </View>
      </SafeAreaView>
    );
