...
function zipCodeBelongsToState(state, zipCode) {
   ...
   */
    (state === "Alaska" || state === "AK") &&
    zipCode >= 99501 &&
    zipCode <= 99950
  ) {
    return true;
  } else if (
    (state === "Alabama" || state === "AL") &&
    zipCode >= 35004 &&
    zipCode <= 36925
  ) {
    return true;
  } else if (
    (state === "Arkansas" || state === "AR") &&
    zipCode >= 71601 &&
    zipCode <= 72959
  ) {
    return true;
    ...
    (state === "Colorado" || state === "CO") &&
    zipCode >= 80001 &&
    zipCode <= 81658
  ) {
    return true;
  } else if (
    (state === "Connecticut" || state === "CT") &&
    zipCode >= 6001 &&
    zipCode <= 6389
  ) {
    return true;
    ...
    (state === "Delaware" || state === "DE") &&
    zipCode >= 19701 &&
    zipCode <= 19980
  ) {
    return true;
  } else if (
    (state === "Florida" || state === "FL") &&
    zipCode >= 32004 &&
    zipCode <= 34997
  ) {
    return true;
  } else if (
    (state === "Georgia" || state === "GA") &&
    zipCode >= 30001 &&
    zipCode <= 31999
  ) {
    return true;
  } else if (
    (state === "Georga" || state === "GA") &&
    zipCode >= 39901 &&
    zipCode <= 39901
  ) {
    return true;
  } else if (
    (state === "Hawaii" || state === "HI") &&
    zipCode >= 96701 &&
    zipCode <= 96898
  ) {
    return true;
    ...
    (state === "Idaho" || state === "ID") &&
    zipCode >= 83201 &&
    zipCode <= 83876
  ) {
    return true;
  } else if (
    (state === "Illinois" || state === "IL") &&
    zipCode >= 60001 &&
    zipCode <= 62999
  ) {
    return true;
  } else if (
    (state === "Indiana" || state === "IN") &&
    zipCode >= 46001 &&
    zipCode <= 47997
  ) {
    return true;
  } else if (
    (state === "Kansas" || state === "KS") &&
    zipCode >= 66002 &&
    zipCode <= 67954
  ) {
    return true;
  } else if (
    (state === "Kentucky" || state === "KY") &&
    zipCode >= 40003 &&
    zipCode <= 42788
  ) {
    return true;
  } else if (
    (state === "Louisiana" || state === "LA") &&
    zipCode >= 70001 &&
    zipCode <= 71232
  ) {
    return true;
    ...
    (state === "Maine" || state === "ME") &&
    zipCode >= 3901 &&
    zipCode <= 4992
  ) {
    return true;
  } else if (
    (state === "Michigan" || state === "MI") &&
    zipCode >= 48001 &&
    zipCode <= 49971
  ) {
    return true;
  } else if (
    (state === "Minnesota" || state === "MN") &&
    zipCode >= 55001 &&
    zipCode <= 56763
  ) {
    return true;
  } else if (
    (state === "Missouri" || state === "MO") &&
    zipCode >= 63001 &&
    zipCode <= 65899
  ) {
    return true;
  } else if (
    (state === "Mississippi" || state === "MS") &&
    zipCode >= 38601 &&
    zipCode <= 39776
  ) {
    return true;
    ...
    (state === "Montana" || state === "MT") &&
    zipCode >= 59001 &&
    zipCode <= 59937
  ) {
    return true;
  } else if (
    (state === "North Carolina" || state === "NC") &&
    zipCode >= 27006 &&
    zipCode <= 28909
  ) {
    return true;
  } else if (
    (state === "North Dakota" || state === "ND") &&
    zipCode >= 58001 &&
    zipCode <= 58856
  ) {
    return true;
  } else if (
    (state === "Nebraska" || state === "NE") &&
    zipCode >= 68001 &&
    zipCode <= 68118
  ) {
    return true;
    ...
    (state === "New Hampshire" || state === "NH") &&
    zipCode >= 3031 &&
    zipCode <= 3897
  ) {
    return true;
  } else if (
    (state === "New Jersey" || state === "NJ") &&
    zipCode >= 7001 &&
    zipCode <= 8989
  ) {
    return true;
    ...
    (state === "Oregon" || state === "OR") &&
    zipCode >= 97001 &&
    zipCode <= 97920
  ) {
    return true;
  } else if (
    (state === "Pennsylvania" || state === "PA") &&
    zipCode >= 15001 &&
    zipCode <= 19640
  ) {
    return true;
  } else if (
    (state === "Rhode Island" || state === "RI") &&
    zipCode >= 2801 &&
    zipCode <= 2940
  ) {
    return true;
    ...
    (state === "Wisconsin" || state === "WI") &&
    zipCode >= 53001 &&
    zipCode <= 54990
  ) {
    return true;
  } else if (
    (state === "West Virginia" || state === "WV") &&
    zipCode >= 24701 &&
    zipCode <= 26886
  ) {
    return true;
  } else if (
    (state === "Wyoming" || state === "WY") &&
    zipCode >= 82001 &&
    zipCode <= 83128
  ) {
    return true;
